...
![Карточка клиента, вкладка «Каталоги»: список активных каталогов, «Выдать каталоги», «Вернуть» и «Печать» в строках](./screenshots/1-catalogs-tab.png)
...
![Окно выдачи каталогов: выбор позиций, дата выдачи, примечание и «Сохранить и открыть бланк»](./screenshots/2-issue-catalogs-modal.png)
